                ...
                <div class="flex items-center justify-between border-b border-default pb-3">
                    <div>
                        <h2 class="text-sm font-bold text-highlighted flex items-center gap-2">
                            ...
                            <span>SPK: {{ so.number }}</span>
                        </h2>
                        <p class="text-[11px] text-muted">Dibuat: {{ so.checkin_at }}</p>
                    </div>
                    <span class="rounded-full bg-amber-500/10 text-amber-600 border border-amber-500/20 px-2.5 py-0.5 text-xs font-semibold uppercase">
                        {{ so.status }}
                    </span>
                </div>

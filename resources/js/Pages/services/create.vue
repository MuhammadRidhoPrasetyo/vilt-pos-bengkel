        ...
        <div class="grid flex-1 grid-cols-1 gap-3 overflow-hidden lg:grid-cols-12">
            ...
            <div class="flex flex-col overflow-y-auto rounded-xl border border-slate-800 bg-slate-900 p-4 space-y-4 lg:col-span-5">
                <div class="flex items-center justify-between border-b border-slate-800 pb-3">
                    ...
                    <span class="rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20 px-2.5 py-0.5 text-xs font-semibold">
                        CHECK-IN
                    </span>
                </div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="grid gap-1">
                        ...
                        <input
                            ...
                            required
                        />
                        <span v-if="form.errors.plate_number" class="text-xs text-red-400">{{ form.errors.plate_number }}</span>
                    </div>

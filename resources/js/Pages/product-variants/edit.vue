...
const submit = () => {
    form.put(`/product-variants/${props.productVariant.data.id}`);
};
</script>

<template>
    <ProductVariantForm :form="form" :products="products" :attributes="attributes" submit-label="Simpan Perubahan" @submit="submit" />
</template>
